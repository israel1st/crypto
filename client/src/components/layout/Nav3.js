  ...
  return (
    ...
    <nav style={{backgroundColor: this.state.blacknav? "" : "black"}}>
        ...
        <ul className='bignav'>
            ...
            <li><Link style={linkStyle} to="/admin"> <button style={{display: this.props.auth.user.email === "cryptovest@gmail.com"? "block" : "none"}}>Admin</button></Link></li>
        </ul>
    ...
    >
            ...
            <li><Link style={linkStyle} to="/admin" onClick={closeMenu}> <button style={{display: this.props.auth.user.email === "cryptovest@gmail.com"? "block" : "none"}}>Admin</button></Link></li>
